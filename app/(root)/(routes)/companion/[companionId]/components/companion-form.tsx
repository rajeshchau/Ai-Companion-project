            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space y-8 pd-10">
                ...
                <div className="grid grid-cols-1 md:gridcols-2 gap-4">
                    ...
                    render={({ field })=>(
                        ...
                        <FormControl>
                            <Input disabled={isLoading} placeholder="ceo and co founder of tesla" {...field} />
                        </FormControl>
                        <FormDescription>
                            sort description for your Ai comapnion 
                        </FormDescription>
                        <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field })=>(
                        ...
                        <FormDescription>
                        This is the instructions to follow by our companion.
                        </FormDescription>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    <FormField
                        ...
                        render={({ field })=>(
                            ...
                            <FormDescription>
                            Write the basic example of the conversation. 
                            </FormDescription>
                            <FormMessage />
                            </FormItem>
                    )}
                ...
                <div className="w-full flex justify-center">
                            ...
                            {initialData ? "edit your companion":"craete your companion"}
